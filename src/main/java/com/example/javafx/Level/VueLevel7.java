...
public class VueLevel7 extends VBox {
    Button beginButton = new Button("Commencer level 7. \n Tu as appris un nouveau sort : \n expelliarmus \n C'est le nombre 5.");
    TextField spellNumber = new TextField("entre le numéro du sort");
    Button escapeButton = new Button("se cacher derrière un pilier");
    Button mangemort1action = new Button("lancer le sort sur Voldemort");
    Button mangemort2action = new Button("lancer le sort sur Bellatrix");

    Label playerpv = new Label("Tes pv");
    Label mangemort1pv = new Label("Voldemort pv");
    Label mangemort2pv = new Label("Bellatrix pv");
    ...
    public VueLevel7(){
        ...
        Image backgroundImage = new Image(getClass().getResource("/w_harry-and-voldemort-by-mike1306-d46tj8l.jpg").toString());
