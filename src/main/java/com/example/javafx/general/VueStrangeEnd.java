...
public class VueStrangeEnd extends VBox {
    Label textetest = new Label("Tu es devenu un magemort, tu as trouvé \nune fin alternative du jeu");


    public VueStrangeEnd(){
        ...
        Image backgroundImage = new Image(getClass().getResource("/unnamed.jpg").toString());
